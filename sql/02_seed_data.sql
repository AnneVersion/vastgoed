...
-- 10. Gezellig, modern appartement bij Leidseplein (P) -- NEW
('leid-5013-3183-bnb0-amsterdam01010',
 'Gezellig, modern appartement bij Leidseplein (P)', 'appartement', 'Modern Appartement',
 'Sfeervol en modern ingericht appartement op loopafstand van het Leidseplein en het Vondelpark. Ideale locatie voor een citytrip in het bruisende centrum van Amsterdam. Met 2 slaapkamers en ruimte voor 4 gasten.',
 'Leidseplein', '1017 PT', 'Amsterdam', 52.36400000, 4.88300000,
 65, 3, 2, 4, 1600.00, 189.00, 75.00, 'B',
 ARRAY['wifi','keuken','wasmachine','TV','handdoeken','beddengoed','haardroger','strijkijzer','rookmelders','EHBO-kit'],
 ARRAY['open keuken','laminaat','dubbel glas'],
 '{"flexibel": 219, "standaard": 189, "niet_restitueerbaar": 165}'::jsonb,
 ARRAY['gradient-modern-4'],
 'Airbnb listing, 4 bedden, rating 4.31', true, '2026-01-01',
 NULL, '[]'::jsonb)
ON CONFLICT (extern_id) DO NOTHING;

-- Update Leidseplein with extra fields
UPDATE woningen SET
    badkamers = 1.5,
    rating = 4.31,
    recensies = 42,
    airbnb_url = 'https://www.airbnb.nl/rooms/50133183'
WHERE extern_id = 'leid-5013-3183-bnb0-amsterdam01010';
